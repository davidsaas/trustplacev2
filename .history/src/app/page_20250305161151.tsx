    ...
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                <Link href="/features" className="px-8 py-3 border border-gray-200 rounded-full text-lg font-medium hover:bg-gray-50 transition-colors inline-flex items-center justify-center">
                  Learn more
                </Link>
              </div>
            </div>
            ...
            <form className="flex items-center">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-full border-0 bg-transparent focus:outline-none focus:ring-0"
                />
              ...
              <button className="ml-2 px-6 py-3 bg-brand text-white rounded-full hover:bg-brand/90 transition-colors">
                Search
              </button>
            </form>
          </div>
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap justify-center items-center gap-8 opacity-70">
          ...
          <div className="h-6 w-16 relative">
            <Image src="/images/youtube.svg" alt="YouTube" fill className="object-contain" />
          </div>
          <div className="h-6 w-16 relative">
          ...
          <div className="h-6 w-16 relative">
            <Image src="/images/google.svg" alt="Google" fill className="object-contain" />
          </div>
        </div>
      </section>
