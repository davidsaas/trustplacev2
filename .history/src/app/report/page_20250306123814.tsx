...
export default function ReportPage() {
  ...
  useEffect(() => {
    ...
    // Create the observer with a lower threshold and more stability
    const observer = new IntersectionObserver(
      (entries) => {
        // Find the most visible entry
        const mostVisible = entries.reduce((prev, current) => {
          return (prev && prev.intersectionRatio > current.intersectionRatio) ? prev : current;
        }, null);
      ...
      { 
        ...
        threshold: [0.1, 0.2, 0.3] // Use multiple thresholds for better detection
      }
    );
  ...
  // Memoize scroll handling to prevent rerenders
