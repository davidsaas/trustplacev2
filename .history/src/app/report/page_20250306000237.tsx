  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 pb-12">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Horizontal Sticky Navigation Menu */}
        <div className="sticky top-0 z-10 bg-white rounded-xl border border-blue-100 shadow-md mb-6 py-2 px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            {/* Location Section */}
            <div id="location" ref={sectionRefs.location} className="md:hidden">
              <Card className="rounded-xl border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                  <p className="text-gray-700 mb-4">
                    {listing.location.address?.line1}, {listing.location.city}, {listing.location.state} {listing.location.zip}
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="rounded-xl border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div className={`p-5 rounded-xl ${getSafetyGradient(safetyMetrics?.overallSafety || safetyScore)} border`}>
          ...
          <div className="hidden md:block md:w-2/3">
            <div className="sticky top-[72px] h-[calc(100vh-120px)] rounded-xl overflow-hidden shadow-md">
              {listing && (
                <MapView
                  latitude={listing.location.coordinates.lat}
                  longitude={listing.location.coordinates.lng}
                  ...
                  markers={[
                    ...
                    ...alternatives.slice(0, 3).map(alt => ({
                      latitude: alt.location.coordinates.lat,
                      longitude: alt.location.coordinates.lng,
                      title: alt.title,
                      color: '#4CAF50' // Green color for alternatives
                    }))
                  ]}
                />
              )}
