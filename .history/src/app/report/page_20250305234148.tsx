  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      try {
        ...
        // Fetch community opinions
        await fetchCommunityOpinions(matchingListing);
              ...
              <Card className="rounded-xl border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                  ...
                  {showSafetyInsights && listing && (
                    <div className="mb-6">
                      <h3 className="text-lg font-semibold text-blue-900 mb-3">Reddit Safety Insights</h3>
                      <SafetyInsights 
                  ...
                  <div className="mt-6">
                    <h3 className="text-lg font-semibold text-blue-900 mb-3">Social Media Comments</h3>
