...
function ReportContent() {
  ...
  const [showSafetyMetrics, setShowSafetyMetrics] = useState(false);
            ...
            <div id="community" ref={sectionRefs.community}>
              <Card className="rounded-xl border-0 shadow-lg">
                <CardHeader className="bg-gradient-to-r">
                  ...
                  <CardDescription>
                    Official safety data based on police reports in this area
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                  {/* Safety Metrics from official data */}
                  {showSafetyMetrics && listing && (
                    <SafetyMetrics
