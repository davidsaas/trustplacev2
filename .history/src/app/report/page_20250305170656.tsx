  ...
  const fetchCommunityOpinions = async (listing: ApifyListing) => {
    ...
    try {
      ...
      const locationData = {
        ...
        neighborhood: listing.location.address?.neighborhood || 
                     listing.location.address?.suburb || 
                     listing.location.address?.city_district,
            ...
            <div id="community" ref={sectionRefs.community}>
              <Card className="rounded-xl border-0 shadow-lg">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100">
                  ...
                  <CardDescription>
                    What locals and travelers say about this area
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                  <div className="space-y-5">
                    {loadingComments ? (
                            ...
                            <div className="flex items-center gap-3">
                              <div className="relative h-12 w-12 rounded-full overflow-hidden border-2 border-white shadow-sm">
                                ...
                                <div className="absolute bottom-0 right-0 h-5 w-5 rounded-full overflow-hidden border-2 border-white bg-white flex items-center justify-center">
                                  <img 
                                    src={getSocialIcon(opinion.source)} 
                                    alt={opinion.source}
                                    className="h-3 w-3"
                                  />
                                </div>
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500">
                                  {new Date(opinion.date).toLocaleDateString(undefined, { year: 'numeric', month: 'long', day: 'numeric' })}
                                </p>
                              </div>
                            </div>
                            <Badge 
                      ...
                      <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        <p className="text-gray-500 text-center py-4">No community opinions found for this location.</p>
                      </div>
                    )}
                  </div>
                </CardContent>
