...
import SupabaseSafetyTakeaways from "@/components/SupabaseSafetyTakeaways";
              ...
              <Card className="rounded-xl border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    {/* Supabase Safety Incidents */}
                    <div className="mt-6 pt-6 border-t border-gray-100">
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">Reported Safety Incidents</h3>
                      {listing && (
                        <SupabaseSafetyTakeaways
              ...
              {safetyReviews.length > 0 && (
                <Card className="rounded-xl border-0 shadow-lg">
                  ...
                  <CardContent className="p-6">
                    ...
                    {/* Reviews - Only visible when showReviews is true */}
                    {showReviews && (
