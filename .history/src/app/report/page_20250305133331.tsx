  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      try {
        ...
        console.log('Photos:', matchingListing.photos);
        console.log('Reviews:', matchingListing.reviews);
        ...
        console.log('Safety reviews:', reviews);
        console.log('Safer alternatives:', saferOptions);
