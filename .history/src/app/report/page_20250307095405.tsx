  ...
  const handleSaveReport = async () => {
    ...
    try {
      ...
      if (existingReport && existingReport.length > 0) {
        ...
        setIsSaved(true);
        setSaving(false);
        toast.info("This report is already saved to your account");
      ...
      // If not saved, insert new record
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Button 
                          ...
                          disabled={saving}
                          className={`bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-1 ${isSaved ? 'bg-blue-700' : ''}`}
                        >
                          <Heart 
                            className={`h-4 w-4 
