                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Button 
                          ...
                          variant="ghost"
                          size="icon"
                          className={`flex items-center justify-center p-2 rounded-full transition-colors ${saving ? 'opacity-70' : ''}`}
                          aria-label={isSaved ? "Unsave report" : "Save report"}
                        >
                          <Heart 
                            className={`h-6 w-6 transition-all ${isSaved ? 'fill-red-500 text-red-500' : 'text-gray-700'} 
