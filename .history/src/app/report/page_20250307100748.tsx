...
export default function ReportPage() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-y border-blue-100 shadow-sm mb-6 py-2 w-full">
        <div className="container mx-auto px-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          variant="outline"
                          size="icon"
                          className="flex items-center justify-center w-10 h-10 rounded-full transition-all hover:bg-blue-50"
