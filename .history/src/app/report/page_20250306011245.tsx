          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            <div id="reviews" ref={sectionRefs.reviews}>
              <Card className="rounded-xl border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                  {/* Review takeaways from our AI analysis */}
                  <ReviewTakeaways 
            ...
            <div id="videos" ref={sectionRefs.videos}>
              <LocationVideos 
                ...
                locationName={`${listing.location.city}, ${listing.location.state}${listing.location.neighborhood ? ` ${listing.location.neighborhood}` : ''}`}
                isLoading={isLoading}
              />
            </div>
