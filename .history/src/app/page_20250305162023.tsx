...
export default function LandingPage() {
  ...
  const safetyTerms = [
    { text: "Safe Areas", color: "text-safety-green" },
    { text: "Risk Zones", color: "text-safety-yellow" },
    { text: "Danger Spots", color: "text-safety-red" }
  ];
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCurrentKeywordIndex((prevIndex) => (prevIndex + 1) % safetyTerms.length);
    }, 2000);
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                ...
                <span className={safetyTerms[currentKeywordIndex].color}>{safetyTerms[currentKeywordIndex].text}</span><br />
            ...
            <div className="md:w-1/2 relative">
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0">
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 transform hover:translate-y-0 transition-transform">
                    <div className="bg-green-400 text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg">
                      Neighborhood Safety
                    </div>
                  </div>
                  <div className="absolute top-1/2 -right-4 translate-y-1/2 transform rotate-90 hover:translate-x-0 transition-transform">
                    <div className="bg-yellow-400 text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg">
                      Transportation Safety
                    </div>
                  </div>
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 transform hover:translate-y-0 transition-transform">
                    <div className="bg-red-400 text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg">
                      Residential Safety
                    </div>
                  </div>
                  <div className="absolute top-1/2 -left-4 translate-y-1/2 transform -rotate-90 hover:translate-x-0 transition-transform">
                    <div className="bg-teal-400 text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg">
                      Tourist Safety
                    </div>
                  </div>
                </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-8">
            <p className="text-xl font-medium text-gray-600">More cities coming soon</p>
          </div>
        </div>
      </section>
