...
export async function GET(request: Request) {
  try {
    ...
    if (takeaways && typeof takeaways === 'object' && 'review_summary' in takeaways && takeaways.review_summary) {
      takeaways.review_summary = `${takeaways.review_summary} (Based on ${safetyReviewCount} safety-related reviews out of ${totalReviewCount} total reviews)`;
    }
