...
import { ArrowRight, Shield, MapPin, Star, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link 
                  href="/login" 
                  className="border border-gray-300 hover:bg-gray-50 text-gray-700 px-6 py-3 rounded-lg font-medium text-center transition-colors"
                >
                  Sign In
                </Link>
              </div>
      ...
      <div className="py-16 md:py-24 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link 
            href="/register" 
            className="inline-flex items-center gap-2 bg-white hover:bg-blue-50 text-blue-600 px-8 py-4 rounded-lg font-medium text-lg transition-colors"
          >
