...
export default function PremiumPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isPremium ? (
          <div className="max-w-2xl mx-auto text-center p-8 bg-white rounded-xl shadow-md">
          ...
          <div className="max-w-5xl mx-auto grid gap-8 md:grid-cols-2">
            ...
            {/* Premium Plan */}
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200 shadow-md relative overflow-hidden">
