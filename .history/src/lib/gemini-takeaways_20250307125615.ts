...
- If safety information is limited, it's better to have fewer specific points or return null than to include non-safety related points
...
- ONLY extract SAFETY information mentioned by video creators who have visited this location
- Focus EXCLUSIVELY on safety-related observations, such as crime, security, walking at night, etc.
...
- Consider both reassuring safety information and warnings
...
- If there is insufficient safety information in the content, it's better to return null than to include non-safety related points`;
