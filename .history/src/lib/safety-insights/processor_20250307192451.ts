...
// For MVP deployment - handle missing Gemini API key gracefully
if (!geminiKey) {
  console.warn('Gemini API key not found. Some AI features will be limited.');
  // Use dummy model for MVP that returns empty results
  genAI = null;
  model = {
