...
CREATE INDEX IF NOT EXISTS review_takeaways_listing_id_idx ON review_takeaways (listing_id);
CREATE INDEX IF NOT EXISTS review_takeaways_expires_at_idx ON review_takeaways (expires_at);
...
COMMENT ON TABLE review_takeaways IS 'Stores AI-generated takeaways from Airbnb reviews for safety analysis'; 